declare global {
  namespace NodeJS {
    interface ProcessEnv {
      ...
      NEXT_PUBLIC_L1_MAINNET_RPC_AUTH_TYPE: string;
      NEXT_PUBLIC_L2_MAINNET_RPC_URL: string;
      NEXT_PUBLIC_L2_MAINNET_RPC_AUTH_TYPE: string;

      // Test-net - L1, L2
      NEXT_PUBLIC_L1_TESTNET_RPC_URL: string;
      NEXT_PUBLIC_L1_TESTNET_RPC_AUTH_TYPE: string;
      NEXT_PUBLIC_L2_TESTNET_RPC_URL: string;
      NEXT_PUBLIC_L2_TESTNET_RPC_AUTH_TYPE: string;

      // Dev-net - L1, L2
      NEXT_PUBLIC_L1_DEVNET_RPC_URL: string;
      NEXT_PUBLIC_L1_DEVNET_RPC_AUTH_TYPE: string;
      NEXT_PUBLIC_L2_DEVNET_RPC_URL: string;
      NEXT_PUBLIC_L2_DEVNET_RPC_AUTH_TYPE: string;
