...
ARG NEXT_PUBLIC_L1_MAINNET_RPC_AUTH_TYPE
ARG NEXT_PUBLIC_L2_MAINNET_RPC_AUTH_TYPE
ARG NEXT_PUBLIC_L1_TESTNET_RPC_AUTH_TYPE
ARG NEXT_PUBLIC_L2_TESTNET_RPC_AUTH_TYPE
ARG NEXT_PUBLIC_L1_DEVNET_RPC_AUTH_TYPE
ARG NEXT_PUBLIC_L2_DEVNET_RPC_AUTH_TYPE
...
ENV NEXT_PUBLIC_L1_MAINNET_RPC_AUTH_TYPE=$NEXT_PUBLIC_L1_MAINNET_RPC_AUTH_TYPE
ENV NEXT_PUBLIC_L2_MAINNET_RPC_AUTH_TYPE=$NEXT_PUBLIC_L2_MAINNET_RPC_AUTH_TYPE
ENV NEXT_PUBLIC_L1_TESTNET_RPC_AUTH_TYPE=$NEXT_PUBLIC_L1_TESTNET_RPC_AUTH_TYPE
ENV NEXT_PUBLIC_L2_TESTNET_RPC_AUTH_TYPE=$NEXT_PUBLIC_L2_TESTNET_RPC_AUTH_TYPE
ENV NEXT_PUBLIC_L1_DEVNET_RPC_AUTH_TYPE=$NEXT_PUBLIC_L1_DEVNET_RPC_AUTH_TYPE
ENV NEXT_PUBLIC_L2_DEVNET_RPC_AUTH_TYPE=$NEXT_PUBLIC_L2_DEVNET_RPC_AUTH_TYPE
